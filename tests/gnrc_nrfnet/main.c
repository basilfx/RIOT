 ...
 *
 * @file
 * @brief       Tests nRFNet handling of gnrc stack.
 *
...
#include "net/gnrc/nrfnet/netif.h"
...
static void _init_interface(void)
{
    ...
    gnrc_nrfnet_netif_add_addr(ifs[0], &addr);
}
...
static void _send_packet(void)
{
    ...
    gnrc_netreg_entry_t dump_nrfnet = GNRC_NETREG_ENTRY_INIT_PID(GNRC_NETREG_DEMUX_CTX_ALL,
                                                                 gnrc_pktdump_pid);
