...
/**
 * @brief   Initialize and the sensor.
 *
 * @return                  0 on successful initialization
 * @return                  -1 on ADC configuration error
 * @return                  -2 on ADC initialization error
 * 
 * This driver assumes that the internal temperature sensor is configures on
 * the first ADC line.
 */
