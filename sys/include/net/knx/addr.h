 ...
 *
 * @see         KNX Specification version 2.1, Architecture v03.00.02
 *
 * @{
 *
 * @file
...
/**
 * @brief   Data type to represent a KNX individual address
 */
typedef knx_addr_t knx_addr_individual_t;
 ...
 */
knx_addr_individual_t *knx_addr_individual(knx_addr_individual_t *result, uint8_t area, uint8_t line, uint8_t device);
...
/**
 * @brief   Convert a string representation of a KNX individual address (x.y.z)
 ...
 */
knx_addr_individual_t *knx_addr_individual_from_str(knx_addr_individual_t *result, const char *addr);
...
/**
 * @brief   Convert a byte-representation of a individual address into a string
 ...
 */
char *knx_addr_individual_to_str(char *result, const knx_addr_t *addr, uint8_t len);
