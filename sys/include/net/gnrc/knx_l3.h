 ...
 *
 * @see         KNX Specification version 2.1, Network Layer v01.01.02
 *
...
/**
 * @brief   Default stack size to use for the KNX L3 thread
 */
...
/**
 * @brief   Default priority for the KNX L3 thread
 */
...
/**
 * @brief   Default message queue size to use for the KNX L3 thread
 */
