 ...
 *
 * @see         KNX Specification version 2.1, Transport Layer v01.02.02
 *
...
/**
 * @brief   Default stack size to use for the KNX L4 thread
 */
...
/**
 * @brief   Default priority for the KNX L4 thread
 */
...
/**
 * @brief   Default message queue size to use for the KNX L4 thread
 */
 ...
 *
 * If the thread is already initialized, the same PID will be returned.
 *
