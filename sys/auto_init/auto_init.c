...
#endif
#if IS_USED(MODULE_GNRC_IPV4_STATIC_ADDR)
extern void auto_init_gnrc_ipv4_static_addr(void);
AUTO_INIT(auto_init_gnrc_ipv4_static_addr,
          AUTO_INIT_PRIO_MOD_GNRC_IPV4_STATIC_ADDR);
#endif
